    ...
    <main>
      <section className="hero-section" id="top">
        <nav className="site-nav">
          ...
          <div className="nav-links"><a href="#properties">Properties</a><a href="#coverage">Coverage Areas</a><a href="#platform">Lead Protection</a><a href="#ai-assistant">AI Assistants</a><a href="#plans">Pricing</a><a href="#faq">FAQ</a></div>
          <div className="nav-actions"><a className="login-link" href="#footer">Login</a><a className="button button-dark" href="#join">Get Started <Arrow /></a></div>
        </nav>
        <div className="hero-content">
          ...
          <div className="hero-copy">
            ...
            <div className="hero-actions"><a className="button button-primary" href="#properties">Search Properties <Arrow /></a><a className="button button-outline" href="#join">List Your Property</a></div>
      ...
      <section className="societies-section section-padding" id="coverage">
        ...
        <div className="society-grid">{societies.map((society) => <a className="society-card" href="#properties" key={society.name}><img src={society.image} alt={society.name} /><span><strong>{society.name}</strong>{society.city}</span></a>)}</div>
        <a className="text-link" href="#coverage-map">View All 130+ Cities &amp; Areas <Arrow /></a>
      </section>
      ...
      <footer className="footer" id="footer"><div className="footer-cta" id="join"><p className="kicker">Ready to join Pakistan&apos;s largest AI Property Network?</p><h2>Build your next deal with <em>Nexus.</em></h2><p>130+ cities. 5,000+ areas. AI-verified listings. Lead protection. Join thousands of sellers, buyers and agents already on Nexus.</p><div className="hero-actions"><a className="button button-primary" href="#top">List My Property Free</a><a className="button button-outline" href="#top">Join As Agent</a></div></div><div className="footer-grid"><div><img className="footer-logo" src={`${assetBase}/transparentlogo.png`} alt="Nexus Property Network" /><p>Pakistan&apos;s first smart property lead network. Connecting sellers, buyers and trusted agents across Pakistan.</p></div><div><h4>Quick Links</h4><a href="#properties">Properties</a><a href="#coverage">Coverage Areas</a><a href="#platform">Lead Protection</a><a href="#process">How It Works</a></div><div><h4>Platform</h4><a href="#plans">Pricing</a><a href="#faq">FAQ</a><a href="#join">Contact</a><a href="#top">Login</a></div><div><h4>Contact Us</h4><a href="tel:03299669565">0329-9669565</a><a href="https://wa.me/923140073794">0314-0073794 (WhatsApp)</a><a href="mailto:nexus.pakistan.properties@gmail.com">nexus.pakistan.properties@gmail.com</a><span>Lahore, Pakistan</span></div></div><div className="footer-bottom"><span>© 2026 Nexus Property Network. All Rights Reserved.</span><span><a href="#top">Privacy Policy</a><a href="#top">Terms of Service</a></span></div></footer>
    </main>
  );
}
